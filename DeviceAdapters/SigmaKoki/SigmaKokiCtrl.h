...
#ifndef _SigmaKokiCTRL_H_
#define _SigmaKokiCTRL_H_
...
//
class SigmaKokiCtrl : public CGenericBase<SigmaKokiCtrl>
{
    public:
        ...
        // SigmaKoki doesn't support equivalent command 

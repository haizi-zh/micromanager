...
MPError::MPError()
{
    ...
    MPError::m_sErrorText[MPError::MPERR_SerialZeroReturn]      = "No response from SigmaKoki controller";                                         // No Response from serial port
    MPError::m_sErrorText[MPError::MPERR_SerialUnknownError]    = "Unknown error codes";                                                       // Unknown serial command
    MPError::m_sErrorText[MPError::MPERR_GENERIC]               = "SigmaKoki adapter error occured";                                               // Unspecified SigmaKoki adapter errors
...
{
    string sErrorText;      // SigmaKoki String

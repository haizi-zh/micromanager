...
#ifndef _SigmaKokiZSTAGE_H_
#define _SigmaKokiZSTAGE_H_
...
//
// define Z stage class that is atached to the SigmaKoki controller
//
...
public:
    ...
    // Busy is not aplicable for SigmaKoki
    ...
    // SigmaKoki, the function will return DEVICE_OK
    // insttead.

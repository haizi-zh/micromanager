...
// from a DLL simpler. All files within this DLL are compiled with the WatecCAMERA_EXPORTS
// symbol defined on the command line. This symbol should not be defined on any project
// that uses this DLL. This way any other project whose source files include this file see 
// WatecCAMERA_API functions as being imported from a DLL, whereas this DLL sees symbols
// defined with this macro as being exported.
#ifdef WatecCAMERA_EXPORTS
#define WatecCAMERA_API __declspec(dllexport)
#else
#define WatecCAMERA_API __declspec(dllimport)
#endif
...
class WatecCamera : public CCameraBase<WatecCamera>
{
public:
	...
	static WatecCamera* GetInstance();
	~WatecCamera();
...
{
public:
   DriverGuard(const WatecCamera * cam);
   ~DriverGuard();
};

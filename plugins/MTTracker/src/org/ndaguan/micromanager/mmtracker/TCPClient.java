...
class TCPClient {
	...
	public static TCPClient getInstance(CMMCore core, int port) {
		if(instance_ == null)
			instance_ = new TCPClient(core, port);
		return instance_;
	}
	...
	public TCPClient(CMMCore core, int port) {
		core_ = core;

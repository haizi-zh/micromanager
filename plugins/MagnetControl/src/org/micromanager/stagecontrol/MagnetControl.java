...
public class MagnetControl implements MMPlugin {
   public static String menuName = "Magnet Control";
   public static String tooltipDescription = "A virtual joystick that allows for manual control"
		   +" of the XY and Z stages";
   private CMMCore core_;
   private ScriptInterface gui_;
   private MagnetControlFrame myFrame_;

   public void setApp(ScriptInterface app) {
      gui_ = app;                                        
      core_ = app.getMMCore();
      if (myFrame_ == null)
         myFrame_ = new MagnetControlFrame(gui_);

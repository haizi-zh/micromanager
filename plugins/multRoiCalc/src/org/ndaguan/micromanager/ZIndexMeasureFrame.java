...
public class ZIndexMeasureFrame extends JFrame {
	...
	private JFrame MagnetManualDialBox;
	...
	public static ZIndexMeasureFrame getInstance(Listener listener,MMStudioMainFrame gui_) {
		if(instance_ == null)
			instance_ = new ZIndexMeasureFrame(listener,gui_);
		return instance_;
	}
	...
	public static void main(String[] arg){
		ZIndexMeasureFrame zm = new ZIndexMeasureFrame(null,null);
		zm.setVisible(true);
	}
	public ZIndexMeasureFrame(Listener listener, MMStudioMainFrame gui_) {

		listener_ = listener;
		if (myStageControlFrame_ == null)
			myStageControlFrame_ = new StageControlFrame(gui_);
		...
		gui_.setBounds(DEFAULT_LOCATION_X,DEFAULT_LOCATION_Y+DEFAULT_HEIGHT+5,DEFAULT_WIDTH,DEFAULT_WIDTH);
	}
	...
	private void initialize() {
		...
		JRadioButtonMenuItem MagnetManual = new JRadioButtonMenuItem("Manual");
		...
		Toolkit kit = Toolkit.getDefaultToolkit();
		final	Image imgC = kit.getImage("icons/C.gif");
		final	Image imgL = kit.getImage("icons/L.gif");
		final	Image imgM = kit.getImage("icons/M.gif");
		final	Image imgS = kit.getImage("icons/S.gif");
		final	Image imgH = kit.getImage("icons/H.gif");
		final	Image imgSet = kit.getImage("icons/set.gif");
		final	Image imgAuto = kit.getImage("icons/Auto.gif");

		JButton butCalibration = new JButton();
		JButton butLiveView = new JButton();

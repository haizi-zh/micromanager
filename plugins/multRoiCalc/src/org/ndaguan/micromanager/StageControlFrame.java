...
public class StageControlFrame extends javax.swing.JFrame {
	...
	private void setRelativeXYStagePosition(double x, double y) {
		try {
			String xyStage = org.ndaguan.micromanager.Preferences.getInstance().magnetXYstage_;
			double[] xpos = new double[1];
			double[] ypos = new double[1];
			core_.getXYPosition(xyStage, xpos, ypos);
//			if (!core_.deviceBusy(xyStage ))
//				core_.setRelativeXYPosition(org.ndaguan.micromanager.Preferences.getInstance().magnetXYstage_, x, y);
				core_.setXYPosition(xyStage, xpos[0]+ x, ypos[0]+y);
		} catch(Exception e) {
			gui_.logError(e);
		}
	}
	...
	{
		try {
			String zStage = org.ndaguan.micromanager.Preferences.getInstance().magnetFocusStage_;
			double zpos = core_.getPosition(zStage);
//			if (!core_.deviceBusy(org.ndaguan.micromanager.Preferences.getInstance().magnetFocusStage_))
//				core_.setRelativePosition(org.ndaguan.micromanager.Preferences.getInstance().magnetFocusStage_, z);

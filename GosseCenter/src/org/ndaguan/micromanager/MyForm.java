...
public class MyForm extends JFrame {
	...
	//	Option.add(Magnet);
		...
		Toolkit kit = Toolkit.getDefaultToolkit();
		final	Image imgC = kit.getImage("I:/icon/C.gif");
		final	Image imgL = kit.getImage("I:/icon/L.gif");
		final	Image imgM = kit.getImage("I:/icon/M.gif");
		final	Image imgS = kit.getImage("I:/icon/S.gif");
		final	Image imgH = kit.getImage("I:/icon/H.gif");
		final	Image imgSet = kit.getImage("I:/icon/set.gif");
		final	Image imgI = kit.getImage("I:/icon/I.gif");
	...
	public class PreferDailogBox {
		...
		private void initialize(){
			...
			DialogListener = new ActionListener() {
				...
				final JLabel label10 = new JLabel("ballRadius/pixel");
				label10.setBounds( ITEMWIDTH*2, 0, ITEMWIDTH,ITEMHEIGHT);
				panel.add(label10);
				ITEM2 = new JTextField();
				ITEM2.setBounds(ITEMWIDTH*2, ITEMHEIGHT, ITEMWIDTH,ITEMHEIGHT);
				panel.add(ITEM2);
